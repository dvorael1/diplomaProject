...
# Joe Song
#
# Created: Feb 10, 2019. Adapted from AUC.R which only plot one curve.
#
# Modified: 
# 
# June 26, 2019. Include a function to use ggplot for generating ROC
#   and PR curves.
#
...
ggplot.ROC.PR.curves <- function(
  list.stats, true.classes, plot=FALSE, title=NULL, digits=2, ...
)
{
